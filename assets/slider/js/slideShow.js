...
$(document).ready(function () {
    ...
    $('.slideWiz').slideWiz({
        ...
        file: [
            {
                src: {
                    main: "assets/slider/image/main.png",
                    cover: "assets/slider/image/cover_1.jpg"
                },
            ...
            },
            {
                src: {
                    main: "assets/slider/image/main.png",
                    cover: "assets/slider/image/cover_2.jpg"
                },
            ...
            },
            {
                src: {
                    main: "assets/slider/image/main.png",
                    cover: "assets/slider/image/cover_3.jpg"
                },
            ...
            },
            {
                src: {
                    main: "assets/slider/image/main.png",
                    cover: "assets/slider/image/cover_4.jpg"
                },
